...
{
      con=Connect.ConnectDB();
        String sql= " select ScholarNo as 'Roll No.',EnrollmentNo as 'Admission No.',StudentName as 'Student Name',DOB,Session,Fathername as 'Fathers Name',MotherName as 'CGPA',Address,ContactNo as 'Contact No.',Email as 'Email ID',Course.CourseID as 'Course ID',Coursename as 'Course', Branch from Course,Student where Course.CourseID=Student.CourseID  order by StudentName ";   
        try{
         pst=con.prepareStatement(sql);
          rs= pst.executeQuery();
...
frm.setVisible(true);
   ...
   try{
    ...
    con=Connect.ConnectDB();
    String sql= "select distinct Session,Branch from Course,Student where Course.CourseID=Student.CourseID and Coursename= '" + cmbCourse.getSelectedItem() + "' and Branch='" + cmbBranch.getSelectedItem() + "' order by session";
   try{
       pst=con.prepareStatement(sql);
       rs=pst.executeQuery();
       while(rs.next())
